...
CREATE TABLE IF NOT EXISTS `FOURPARKSDATABASE`.`CARD` (
  ...
  CONSTRAINT `FK_CARD_CLIENTE`
    ...
    REFERENCES `FOURPARKSDATABASE`.`CLIENT` (`IDUSER` , `FK_IDDOCTYPE`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = INNODB
DEFAULT CHARACTER SET = UTF8MB3;
...
CREATE TABLE IF NOT EXISTS `FOURPARKSDATABASE`.`PARKING` (
  ...
  CONSTRAINT `FK_PARKING_CITY_UNIQUE`
    UNIQUE (`IDPARKING`,`FK_IDCITY`),
  ...
  CONSTRAINT `FK_PARKING_ADMINISTRADOR`
    ...
    REFERENCES `FOURPARKSDATABASE`.`ADMINISTRATOR` (`IDUSER` , `FK_IDDOCTYPE`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION
) ENGINE = INNODB
DEFAULT CHARACTER SET = UTF8MB3;
...
CREATE TABLE IF NOT EXISTS `FOURPARKSDATABASE`.`PARKINGSPACE` (
  ...
  PRIMARY KEY (`IDPARKINGSPACE`,`FK_IDPARKING`,`FK_IDCITY`,`FK_IDVEHICLETYPE`, `FK_IDPARKINGTYPE`),
