...
-- -----------------------------------------------------
-- TABLE `FOURPARKSDATABASE`.`USER_DEBT`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `FOURPARKSDATABASE`.`USERDEBT` (
  `DEBTAMOUNT` INT NOT NULL,
  `OWES` TINYINT NOT NULL,
  `IDUSER` VARCHAR(13) NOT NULL,
  `FK_IDDOCTYPE` VARCHAR(3) NOT NULL,
  PRIMARY KEY (`IDUSER`,`FK_IDDOCTYPE`),
  INDEX `FK_USER_DEBT_IDX` (`IDUSER` ASC, `FK_IDDOCTYPE` ASC) VISIBLE,
  CONSTRAINT `FK_USERDEBT_USER` 
...
CREATE TABLE IF NOT EXISTS `FOURPARKSDATABASE`.`RESERVATION` (
  ...
  INDEX `FK_RESERVATION_PARKINGSPACE_IDX` (`FK_IDPARKINGSPACE` ASC, `FK_IDPARKING` ASC, `FK_IDCITY` ASC) VISIBLE,
  ...
  CONSTRAINT `FK_RESERVATION_PARKINGSPACE`
    FOREIGN KEY (`FK_IDPARKINGSPACE`, `FK_IDPARKING`, `FK_IDCITY`)
    REFERENCES `FOURPARKSDATABASE`.`PARKINGSPACE` (`IDPARKINGSPACE`, `FK_IDPARKING`, `FK_IDCITY`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
CREATE TABLE IF NOT EXISTS `FOURPARKSDATABASE`.`SCORESYSTEM` (
  `TARGETPOINTS` INT NULL DEFAULT NULL,
  `TARGETVALUE` FLOAT NULL DEFAULT NULL,
  `IDPARKING` INT NOT NULL,
  `FK_IDCITY` VARCHAR(3) NOT NULL,
  PRIMARY KEY (`IDPARKING`,`FK_IDCITY`),
  INDEX `FK_SCORESYSTEM_PARKING_IDX` (`IDPARKING` ASC) VISIBLE,
  CONSTRAINT `FK_SCORESYSTEM_PARKING`
    FOREIGN KEY (`IDPARKING`, `FK_IDCITY`)
    REFERENCES `FOURPARKSDATABASE`.`PARKING` (`IDPARKING`, `FK_IDCITY`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION
)ENGINE = INNODB
...
-- -----------------------------------------------------
-- TABLE `FOURPARKSDATABASE`.`CLIENTSCORE`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `FOURPARKSDATABASE`.`CLIENTSCORE` (
  `SCOREPOINTS` INT NULL DEFAULT NULL,
  `RESIDUE` FLOAT NULL DEFAULT NULL,
  `IDPARKING` INT NOT NULL,
  `FK_IDCITY` VARCHAR(3) NOT NULL,
  `FK_CLIENT_IDUSER` VARCHAR(13) NOT NULL,
  `FK_CLIENT_IDDOCTYPE` VARCHAR(3) NOT NULL,
  PRIMARY KEY (`IDPARKING`,`FK_IDCITY`,`FK_CLIENT_IDUSER`,`FK_CLIENT_IDDOCTYPE`),
  INDEX `FK_CLIENTSCORE_PARKING_IDX` (`IDPARKING` ASC,`FK_IDCITY` ASC) VISIBLE,
  INDEX `FK_CLIENTSCORE_CLIENTE_IDX` (`FK_CLIENT_IDUSER` ASC, `FK_CLIENT_IDDOCTYPE` ASC) VISIBLE,
  CONSTRAINT `FK_CLIENTSCORE_PARKING`
    FOREIGN KEY (`IDPARKING`, `FK_IDCITY`)
    REFERENCES `FOURPARKSDATABASE`.`SCORESYSTEM` (`IDPARKING`, `FK_IDCITY`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `FK_CLIENTSCORE_CLIENTE`
    FOREIGN KEY (`FK_CLIENT_IDUSER` , `FK_CLIENT_IDDOCTYPE`)
    REFERENCES `FOURPARKSDATABASE`.`USER` (`IDUSER` , `FK_IDDOCTYPE`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION
...
BEGIN
    ...
    IF rate_exists = 0 THEN
        ...
        VALUES (3000, 2500, NEW.ISUNCOVERED, NEW.FK_IDPARKING, NEW.FK_IDCITY, NEW.FK_IDVEHICLETYPE);
    END IF;
END//
...
BEGIN
    ...
    IF NEW.STARTDATERES = NEW.ENDDATERES AND NEW.STARTTIMERES >= NEW.ENDTIMERES THEN
