...
import image1 from '../../assets/parqueadero1.jpg';
import image2 from '../../assets/parqueadero2.jpg';
import image3 from '../../assets/parqueadero3.jpg';
    ...
    return (
      <div className="relative">
        <Slider {...settings} autoplay={true} autoplaySpeed={3000}>
          <div>
            <img src={image2} alt="Imagen 1" className="rounded-lg w-full" />
          </div>
          <div>
            <img src={image1} alt="Imagen 2" className="rounded-lg w-full" />
          </div>
          <div>
            <img src={image3} alt="Imagen 3" className="rounded-lg w-full" />
          </div>
